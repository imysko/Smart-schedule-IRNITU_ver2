...
registration_messages = {
    ...
    'repeat_registration': 'Пройдите повторную регистрацию\n'
                           'Кем вы являетесь?',
    'new_registration': 'Введите название группы (например: ИСТБ-19) либо фамилию преподавателя (например: Корняков)',
...
search_messages = {
    'input_classroom': 'Введите название аудитории.\n'
                       'Например: В-214',
    'input_teacher': 'Введите ФИО преподавателя.\n'
                     'Например: Корняков Михаил Викторович',
    'input_group': 'Введите группу.\n'
                       'Например: ИСТб-20-3',
