...
def start_student_reg(bot, message, storage):
    ...
    institutes = postgre_storage.get_institutes()
    bot.edit_message_text(message_id=message_id, chat_id=chat_id, text=f'Для начала выберете институт',
    ...
    if 'institute' in data:
        ...
        courses = postgre_storage.get_courses_by_institute(data['institute'])
        ...
        storage.save_or_update_user(chat_id=chat_id, institute=data['institute'])
        try:
